  ...
  return (
    <div className="bg-white text-black text-center">
      ...
      <ul className="flex justify-center space-x-3">
        <li>
          <a href="https://www.linkedin.com/in/hossainaraf/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile of Hossain Araf">
            <svg className="cursor-pointer rounded-md shadow-md bg-black shadow-transparent transition-all duration-300 hover:bg-blue-200" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 92 93" fill="none">
        ...
        <li>
          <a href="https://www.facebook.com/hossainArafUtech" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile of Hossain Araf">
            <svg className="cursor-pointer rounded-md shadow-md bg-black shadow-transparent transition-all duration-300 hover:bg-blue-200" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 92 92" fill="none">
