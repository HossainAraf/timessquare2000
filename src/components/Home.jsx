    ...
    <div className="container mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-4">
      <Link to="/timessquare" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Times Square</h5>
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Explore the mystical world of TimesSquare—immerse yourself in enchantingTimesSquareusic, timeless poetry, rich historical narratives, and inspiring biographies of revered saints and scholars.</p>
          <p>Read More</p>
        </div>
      </Link>
